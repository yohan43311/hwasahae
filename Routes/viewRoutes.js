...
router.use("/registerOk",express.static("Views/src/pages/SIgnUp/success_signUp/success_signUp.html")); //회원가입 성공
router.use("/payment", express.static("Views/src/pages/Payment")); //결제
router.use("/paid",express.static("Views/src/pages/Payment/success_payment/success_payment.html")); //결제완료
