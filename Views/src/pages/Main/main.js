...
const itemList = [
  {
    imgUrl: "/design/skincure/0759ansome/icon_prd04.gif",
    title: "비타민C화이트닝 에센스",
    price: 660000,
    discount: 450000,
  },
  ...
  .map(
    (item) => `
        ...
        <div class="tb-center">
            <div class="box">
                <div class="thumb salebox">
                    <a href="/shop/shopdetail.html?branduid=365378&amp;xcode=055&amp;mcode=004&amp;scode=011&amp;special=1&amp;GfDT=aGZ3UQ%3D%3D"><img class="MS_prod_img_m" src="${item.images}" alt="상품 섬네일"></a>
                    <div class="info_icon">
                        <span><a href="javascript:viewdetail('055004000353', '1', '');"><img src="http://skincure.co.kr/design/skincure/0759ansome/icon_prd04.gif" alt="미리보기"></a></span>                                                                            </div>
      ...
      .map(
        (item) => `
            ...
            <div class="tb-center">
                <div class="box">
                    <div class="thumb salebox">
                        <a href="/shop/shopdetail.html?branduid=100&amp;xcode=055&amp;mcode=004&amp;scode=012&amp;special=11&amp;GfDT=aWl3UQ%3D%3D"><img class="MS_prod_img_m" src="${item.images[0]}" alt="상품 섬네일"></a>
                        <div class="info_icon">
                            <span><a href="/"><img src="http://skincure.co.kr/design/skincure/0759ansome/icon_prd04.gif" alt="미리보기"></a></span>                                                                            </div>
                        <input type="hidden" name="custom_price" value="66000">
                        <input type="hidden" name="product_price" value="37000">
                        <div id="sale_bg" style="display: block;"><span class="sale_text">44%</span></div>
                    </div>
